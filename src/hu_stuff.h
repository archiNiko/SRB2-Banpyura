...
#define CHAT_BUFSIZE 64		// I'm sorry to break it to you, but that is NOT enough messages.
...
void HU_drawPing(INT32 x, INT32 y, UINT32 ping, boolean notext, INT32 flags, INT32 pnum);	// Lat': Ping drawer for scoreboard.
